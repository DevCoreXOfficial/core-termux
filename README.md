...
<p align="center">
  <strong>Transform your Android device into a powerful development workstation!</strong>
</p>
...
<p align="center">
  <em>Showcasing the Powerlevel10k prompt (left) and NvChad editor (right).</em>
</p>
...
Check out our [YouTube Channel](https://youtube.com/@devcorex?si=NNuXTcjqGPGISetL) for video demonstrations!

---

## **✨ Features**

- 🚀 **Fully Automated Setup**: Get your complete development environment ready with just one command - no manual configuration needed.
- 💻 **Professional Code Editor**: Pre-configured Neovim with the blazingly fast **NvChad** framework, featuring LSP support, autocompletion, file explorer, git integration, and more.
...
- 📦 **Comprehensive Package Collection**: Includes programming languages (Node.js, Python, PHP, Perl), databases (MongoDB, PostgreSQL, MariaDB, SQLite), development tools (Git, GitHub CLI, Neovim), and utilities (curl, wget, jq, fzf, and more).
- 🤖 **AI-Powered Tools**: Integrated AI assistants like **Gemini CLI** and **Qwen Code** to boost your productivity with code generation, explanations, and more.
- 🔄 **Auto-Updates**: Keep your environment, tools, and configurations up to date automatically with every shell session.
...
- 🔧 **Custom Aliases**: Includes useful aliases like `ls` enhanced with `lsd` for colorful directory listings and `cat` enhanced with `bat` for syntax-highlighted file viewing.
...
5. **Watch Tutorials**: Check out our [Neovim Course](https://youtu.be/Uqgvzd7Sec0?si=2I-2WIFwZOB7sCkR) for in-depth guidance
...
- 📺 **YouTube Channel**: [DevCoreX](https://youtube.com/@devcorex?si=NNuXTcjqGPGISetL) - Tutorials and demonstrations
- 🎓 **Neovim Course**: [Neovim - NvChad](https://youtu.be/Uqgvzd7Sec0?si=2I-2WIFwZOB7sCkR) - Learn to use NvChad effectively
- 📖 **Documentation**: This comprehensive README and related guides
- 💻 **GitHub Repository**: [Core-Termux on GitHub](https://github.com/DevCoreXOfficial/core-termux)

### **Community Resources**

- 💬 **GitHub Discussions**: Join discussions about Core-Termux
- 🐙 **GitHub Issues**: Report bugs or request features
- 📚 **Learning Materials**: Additional tutorials and guides
...
- **Termux App** installed from [GitHub](https://github.com/termux/termux-app/actions/workflows/debug_build.yml) (recommended)
...
2. **Install Termux**:
   - Download from [GitHub](https://github.com/termux/termux-app/actions/workflows/debug_build.yml)
...
```
core-termux/
├── assets/             # Fonts and images (Meslo Nerd Font, screenshots)
├── bootstrap.sh        # Called by update.sh, handles the update of all tools
├── config              # Color variables and settings for scripts
├── setup.sh            # Main setup script - installs everything
├── update.sh           # Syncs files and runs bootstrap.sh for updates
...
- **Custom Extra Keys**: Optimized key layout for better navigation and productivity:
  ```
  [['ESC','</>','-','HOME',{key: 'UP', display: '▲'},'END','PGUP'],
  ['TAB','CTRL','ALT',{key: 'LEFT', display: '◀'},{key: 'DOWN', display: '▼'},{key: 'RIGHT', display: '▶'},'PGDN']]
  ```
...
<p align="center">
  <strong>Questions? Issues? Join our community for support!</strong>
</p>
