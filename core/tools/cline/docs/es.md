...
- **Proyecto:** https://cline.bot
- **Código fuente:** https://github.com/cline/cline
- **Dependencias:** nodejs

## ¿Qué es?

Agente de programación open source del equipo de Cline.
...
```bash
core install cline        # instalar
core update cline         # actualizar
core uninstall cline      # eliminar
```
...
- Documentación completa en inglés: `core show cline`.
