...
if [[ "${1:-}" == "install" ]]; then install_psqlformat; fi
if [[ "${1:-}" == "uninstall" ]]; then uninstall_psqlformat; fi
if [[ "${1:-}" == "update" ]]; then update_psqlformat; fi
if [[ "${1:-}" == "reinstall" ]]; then reinstall_psqlformat; fi
