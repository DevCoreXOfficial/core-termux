...
- **Proyecto:** https://opencode.ai
- **Código fuente:** https://github.com/anomalyco/opencode
- **Dependencias:** git, ripgrep, jq, nodejs

## ¿Qué es?

Agente de programación open source para tu terminal.
...
```bash
core install opencode        # instalar
core update opencode         # actualizar
core uninstall opencode      # eliminar
```
...
- Documentación completa en inglés: `core show opencode`.
