...
- **Proyecto:** https://www.soimort.org/translate-shell/
- **Código fuente:** https://github.com/soimort/translate-shell
- **Dependencias:** ninguna requerida por Core

## ¿Qué es?

Traductor de línea de comandos (Google, Bing, Apertium...).
...
```bash
core install translate        # instalar
core update translate         # actualizar
core uninstall translate      # eliminar
```
...
- Documentación completa en inglés: `core show translate`.
