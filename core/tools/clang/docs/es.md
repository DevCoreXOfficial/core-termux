...
- **Proyecto:** https://clang.llvm.org
- **Código fuente:** https://github.com/llvm/llvm-project
- **Dependencias:** ninguna requerida por Core

## ¿Qué es?

Compilador C/C++ del proyecto LLVM.
...
```bash
core install clang        # instalar
core update clang         # actualizar
core uninstall clang      # eliminar
```
...
- Documentación completa en inglés: `core show clang`.
