...
Agente alojado que planifica, construye, prueba y verifica loops completos de trabajo.
...
```bash
core install keelcode        # instalar
core update keelcode         # actualizar
core uninstall keelcode      # eliminar
```
...
- Documentación completa en inglés: `core show keelcode`.
