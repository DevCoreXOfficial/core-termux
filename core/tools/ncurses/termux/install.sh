...
if [[ "${1:-}" == "install" ]]; then install_ncurses; fi
if [[ "${1:-}" == "uninstall" ]]; then uninstall_ncurses; fi
if [[ "${1:-}" == "update" ]]; then update_ncurses; fi
if [[ "${1:-}" == "reinstall" ]]; then reinstall_ncurses; fi
