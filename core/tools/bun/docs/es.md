...
- **Proyecto:** https://bun.sh
- **Código fuente:** https://github.com/oven-sh/bun
- **Dependencias:** ninguna requerida por Core

## ¿Qué es?

Runtime de JavaScript ultrarrápido con bundler y gestor de paquetes incluidos.
...
```bash
core install bun        # instalar
core update bun         # actualizar
core uninstall bun      # eliminar
```
...
- Documentación completa en inglés: `core show bun`.
