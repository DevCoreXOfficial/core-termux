...
- **Proyecto:** https://github.com/mvdan/sh
- **Código fuente:** https://github.com/mvdan/sh
- **Dependencias:** ninguna requerida por Core

## ¿Qué es?

Formateador de shell scripts compatible con POSIX/Bash.
...
```bash
core install shfmt        # instalar
core update shfmt         # actualizar
core uninstall shfmt      # eliminar
```
...
- Documentación completa en inglés: `core show shfmt`.
