...
> Consulta la versión completa con `core show perl` (inglés).

## Información del Paquete

- **Nombre:** Perl
- **Tags:** language, runtime
- **Proyecto:** https://www.perl.org
...
```bash
core install perl        # instalar
core update perl         # actualizar
core uninstall perl      # eliminar
core search perl         # encontrarlo entre las herramientas
```
