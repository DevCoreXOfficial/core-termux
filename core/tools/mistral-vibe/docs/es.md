...
- **Proyecto:** https://mistral.ai
- **Código fuente:** https://github.com/mistralai/mistral-vibe
- **Dependencias:** ninguna requerida por Core

## ¿Qué es?

Asistente de programación potenciado por los modelos de Mistral.
...
```bash
core install mistral-vibe        # instalar
core update mistral-vibe         # actualizar
core uninstall mistral-vibe      # eliminar
```
...
- Documentación completa en inglés: `core show mistral-vibe`.
