...
```bash
core install mistral-vibe
```

### Uninstall

```bash
core uninstall mistral-vibe
```

### Update

```bash
core update mistral-vibe
```
...
```bash
core install mistral-vibe      # install
core update mistral-vibe       # update
core uninstall mistral-vibe    # remove
```
...
- Spanish docs (when available): `core show mistral-vibe:es`.
