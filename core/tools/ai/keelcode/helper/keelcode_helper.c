...
int main(int argc, char** argv) {
    ...
    // Tell KeelCode where the ripgrep sidecar lives
    setenv("KEELCODE_RG_PATH", "/data/data/com.termux/files/home/.local/share/core-termux-data/keelcode/rg", 1);
    ...
    char real_bin[] = "/data/data/com.termux/files/home/.local/share/core-termux-data/keelcode/keelcode";
