...
Automatizador de builds basado en Makefiles.
...
```bash
core install make        # instalar
core update make         # actualizar
core uninstall make      # eliminar
```
...
- Documentación completa en inglés: `core show make`.
