...
if [[ "${1:-}" == "install" ]]; then install_localtunnel; fi
if [[ "${1:-}" == "uninstall" ]]; then uninstall_localtunnel; fi
if [[ "${1:-}" == "update" ]]; then update_localtunnel; fi
if [[ "${1:-}" == "reinstall" ]]; then reinstall_localtunnel; fi
