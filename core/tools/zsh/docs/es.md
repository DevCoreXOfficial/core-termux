...
> Consulta la versión completa con `core show zsh` (inglés).

## Información del Paquete

- **Nombre:** ZSH Shell Environment
...
```bash
core install zsh        # instalar
core update zsh         # actualizar
core uninstall zsh      # eliminar
core search zsh         # encontrarlo entre las herramientas
```
