...
install_ai() {
  ...
  list_item "Cactus Needle ${GRAY}(${D_GREEN}needle${GRAY})"
  list_item "Cactus Engine CLI ${GRAY}(${D_GREEN}cactus${GRAY})"
  list_item "Goose CLI ${GRAY}(${D_GREEN}goose${GRAY})"
  list_item "KeelCode ${GRAY}(${D_GREEN}keelcode${GRAY})"
...
reinstall_ai() {
  ...
  list_item "Cactus Needle"
  list_item "Cactus Engine CLI"
  list_item "Goose CLI"
  list_item "KeelCode"
  list_item "Cursor CLI"
  list_item "Kimchi"
  list_item "MiMoCode"
  list_item "Engram"
  list_item "CodeGraph"
