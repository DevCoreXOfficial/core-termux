...
install_full() {
	...
	list_item "AI tools (Qwen Code, Gemini CLI, Mistral Vibe, OpenClaude, Claude Code, OpenClaw, Ollama, Codex CLI, OpenCode, Engram, CodeGraph, Pi, Antigravity CLI, Minimax CLI, Gentle AI, GGA)"
