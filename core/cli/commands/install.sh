...
install_main() {
	...
	if [[ $# -eq 0 ]]; then
		...
		list_item "ai         - AI tools (Qwen Code, Gemini CLI, Mistral Vibe, OpenClaude, Claude Code, OpenClaw, Ollama, Codex CLI, OpenCode, Engram, CodeGraph, Pi, Antigravity CLI, Minimax CLI, Gentle AI, GGA)"
